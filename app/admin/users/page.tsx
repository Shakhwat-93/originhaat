...
const AVAILABLE_PERMISSIONS = [
  ...
  { key: 'courier', label: 'Courier Booking (কুরিয়ার শিপমেন্ট)', desc: 'পাঠাও ও স্টিডফাস্ট কুরিয়ার বুকিং ও ট্র্যাকিং' },
  { key: 'inbox', label: 'Inbox Chat (কাস্টমার ইনবক্স)', desc: 'গ্রাহকদের সাথে লাইভ চ্যাট ও মেসেজিং সুবিধা' },
  ...
  { key: 'landing', label: 'Landing Pages (ল্যান্ডিং পেজ)', desc: 'সিঙ্গেল প্রোডাক্ট ল্যান্ডিং পেজ তৈরি ও এডিট করার অনুমতি' },
  { key: 'reports', label: 'Sales Report (সেলস রিপোর্ট)', desc: 'অর্ডার ও বিক্রয়ের সম্পূর্ণ রিপোর্ট ও লাভ-ক্ষতির স্ট্যাট দেখার অনুমতি' },
